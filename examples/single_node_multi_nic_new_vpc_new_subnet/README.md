...
- Prepare GPC instance image
  ...
  * Example: gcloud compute images create rhel9-20240216075746-multi-voltmesh-us --family rhel9 --guest-os-features="MULTI_IP_SUBNET" --source-uri gs://ves-images/rhel9-20240216075746-multi-voltmesh.tar.gz
